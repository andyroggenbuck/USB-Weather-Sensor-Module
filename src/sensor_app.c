...
/* Application Data
  ...
  Remarks:
    This structure should be initialized by the SENSOR_APP_Initialize function.
    ...
    switch ( sensor_appData.state )
    {
        ...
        case SENSOR_APP_STATE_INIT:
        {
            ...
            if (appInitialized)
            {
                ...
                sensor_appData.state = SENSOR_APP_STATE_SERVICE_TASKS;
            }
            break;
        }

        case SENSOR_APP_STATE_SERVICE_TASKS:
        {
